      ...
      <AnimatedDiv axis='y' direction={50} delay={0}>
        ...
        <div className='flex flex-col md:flex-row'>
          <div className='flex flex-col md:basis-[80%] mb-[4rem] md:mr-[4rem]'>
            <Paragraph>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic ea inventore libero itaque amet id ipsam ipsa voluptatem ratione cum.
          ...
          <div className='relative self-center basis-1/2'>
              <figure
              ...
              >
                <img src={`/anasazkoul.jpg`} alt='Anas Azkoul' className='rounded-lg' />
              </figure>
          </div>
        </div>
      </AnimatedDiv>
